 ...
 * @desc 声音消息
 */
public class SoundElemHolder extends MessageContentHolder {
    ...
    public SoundElemHolder(@NonNull View itemView, RecyclerView.Adapter adapter) {
        super(itemView, adapter);
        progressBar = itemView.findViewById(R.id.progress);
        tvProgress = itemView.findViewById(R.id.tv_progress);
        ivSound = itemView.findViewById(R.id.iv_sound);
        ivDownload = itemView.findViewById(R.id.iv_download);
    }


    public void showMessage(SoundElemVO elemVO) {
        ...
        if (elemVO.getTimMessage().isSelf()) {
            ivSound.setImageResource(R.drawable.ic_voice_right);
        } else {
            ivSound.setImageResource(R.drawable.ic_voice_left);
        }
    ...
    private void downSound(SoundElemVO elemVO) {
        ...
        if (file.exists()) {
            ...
            V2TIMSoundElem elem = elemVO.getTimElem();
            elem.downloadSound(soundPath, new V2TIMDownloadCallback() {
                @Override
    ...
    public int messageContentView() {
        return R.layout.item_message_sound;
    }
}
