...
public class AudioPlayer {
    ...
    private static String CURRENT_RECORD_FILE = TUIKitConstants.MESSAGE_RECORD_DIR + "auto_";
        ...
        try {
            ...
            mHandler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(TUIKit.getAppContext(), "已达到最大语音长度", Toast.LENGTH_SHORT).show();
                }
            }, 60 * 1000);//最大时长
        } catch (Exception e) {
            stopInternalRecord();
    ...
    public void startPlay(String filePath, Callback callback) {
        ...
        try {
            ...
            Toast.makeText(TUIKit.getAppContext(), "语音文件已损坏或不存在", Toast.LENGTH_SHORT).show();
            stopInternalPlay();
    ...
    public int getDuration() {
        ...
        try {
            ...
            Toast.makeText(TUIKit.getAppContext(), e.toString(), Toast.LENGTH_SHORT).show();
        }
        if (duration < 0) {
            duration = 0;
        }
